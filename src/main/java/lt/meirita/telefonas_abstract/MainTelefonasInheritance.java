...
import lt.meirita.telefonas_inheritance.Taksofonas;
import lt.meirita.telefonas_inheritance.Telefonas;

public class MainTelefonasInheritance {
    public static void main(String[] args) {
        lt.meirita.telefonas_inheritance.Telefonas telefonas01 = new Telefonas("8-5-1231234");

        Mobilus mobilus01 = new Mobilus("8-555-111122", "123455");

        lt.meirita.telefonas_inheritance.Taksofonas taksofonas01 = new Taksofonas(0.8);
